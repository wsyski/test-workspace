...
const index = (liferayParams) => {
    ...
    ReactDOM.render(process.env.NODE_ENV === 'development' ? (React.createElement(React.StrictMode, null, markup)) : (React.createElement(React.Fragment, null, markup)), document.getElementById(liferayParamsWithDefaults.portletElementId));
};
