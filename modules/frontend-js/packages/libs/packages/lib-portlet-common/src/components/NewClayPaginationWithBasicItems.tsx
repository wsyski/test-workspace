...
const NewClayPaginationWithBasicItems = React.forwardRef<HTMLUListElement, IProps>(
    (
        {
            activePage,
            ariaLabels = {
...
NewClayPaginationWithBasicItems.displayName = 'NewClayPaginationWithBasicItems';

export default NewClayPaginationWithBasicItems;
