...
import NewClayPaginationWithBasicItems from "./NewClayPaginationWithBasicItems";
...
export const NewClayPaginationBarWithBasicItems: React.FunctionComponent<IProps> = ({
                                                                                      activeDelta,
                                                                                      activePage = 1,
                                                                                      ariaLabels,
  ...
  }, [activePage, onPageChange, totalPages]);
...
export default NewClayPaginationBarWithBasicItems;
