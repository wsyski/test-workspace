...
import { PROJECT_VERSION } from "../constants/PortletCommonConstants";

export const ARENA_ICON_SPRITEMAP = `/o/images-provider-${PROJECT_VERSION}/images/icons/icons.svg`;
